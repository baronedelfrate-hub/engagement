...
const PermissionGate = ({ permission, children, fallback = false }) => {
  ...
  if (fallback) {
    return (
      <div className="p-4 border border-red-200 bg-red-50 rounded-lg text-red-700 dark:border-red-800 dark:bg-red-950/30 dark:text-red-400 flex items-center gap-3">
