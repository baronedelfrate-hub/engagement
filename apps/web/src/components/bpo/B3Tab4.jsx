...
export default function B3Tab4() {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center bg-background rounded-xl border border-border shadow-sm min-h-[400px] animate-in fade-in zoom-in-95 duration-300">
      ...
      <h3 className="text-2xl font-bold text-foreground mb-3">Gestão e Controle Gerencial</h3>
      <p className="text-muted-foreground max-w-md text-base leading-relaxed">
        Conteúdo em desenvolvimento. Ferramentas para controle de indicadores, relatórios gerenciais e métricas estratégicas.
      </p>
    </div>
  );
}