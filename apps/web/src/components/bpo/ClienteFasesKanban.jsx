          ...
          <CardContent className="p-4 flex-1 flex flex-col">
            <div className="space-y-2 mb-4 flex-1">
              <div className="flex items-center text-xs text-muted-foreground">
                ...
                <span>
                  {faseData.data_inicio ? new Date(faseData.data_inicio).toLocaleDateString('pt-BR') : 'A iniciar'}
                  {' - '}
                  {faseData.data_conclusao ? new Date(faseData.data_conclusao).toLocaleDateString('pt-BR') : 'Em aberto'}
                </span>
              </div>
              <div className="flex items-center text-xs text-muted-foreground">
