...
const renderInput = (formData, handleFieldChange, bloco, id, label, type = 'text', placeholder = '') => (
  <div className="space-y-1.5 mb-4">
    <Label htmlFor={`${bloco}-${id}`} className="text-slate-700 font-medium">{label}</Label>
    <Input id={`${bloco}-${id}`} type={type} placeholder={placeholder} value={formData[bloco][id] || ''} onChange={(e) => handleFieldChange(bloco, id, e.target.value)} className="bg-white border-slate-200" />
  </div>
);
...
const renderTextarea = (formData, handleFieldChange, bloco, id, label, placeholder = '', rows = 3) => (
  <div className="space-y-1.5 mb-4">
    <Label htmlFor={`${bloco}-${id}`} className="text-slate-700 font-medium">{label}</Label>
    <Textarea id={`${bloco}-${id}`} placeholder={placeholder} rows={rows} value={formData[bloco][id] || ''} onChange={(e) => handleFieldChange(bloco, id, e.target.value)} className="bg-white border-slate-200 resize-y" />
  </div>
);

const renderCheckbox = (formData, handleFieldChange, bloco, id, label) => (
  <div className="flex items-center space-x-2 py-2">
    <Checkbox id={`${bloco}-${id}`} checked={formData[bloco][id] || false} onCheckedChange={(checked) => handleFieldChange(bloco, id, checked)} className="border-slate-300 data-[state=checked]:bg-primary" />
    <Label htmlFor={`${bloco}-${id}`} className="text-sm font-medium leading-none cursor-pointer text-slate-700">{label}</Label>
  </div>
);
    ...
    <RadioGroup value={formData[bloco][id] || ''} onValueChange={(val) => handleFieldChange(bloco, id, val)} className="flex flex-col space-y-2 mt-2">
      {options.map((opt) => (
        <div key={opt.value} className="flex items-center space-x-2">
          ...
          <Label htmlFor={`${bloco}-${id}-${opt.value}`} className="cursor-pointer text-slate-600">{opt.label}</Label>
        </div>
      ))}
    </RadioGroup>
  </div>
...
const ProgressHeader = ({ progress }) => (
  <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm mb-6">
    <div className="flex justify-between items-center mb-2">
      <span className="text-sm font-semibold text-slate-600">Progresso Geral do Preenchimento</span>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-primary/5 border border-primary/10 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-slate-800">Bloco 01 – Diagnóstico & Processo</h2>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">1. Estrutura Organizacional</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
          ...
          <div className="col-span-1 md:col-span-2">
            <Label className="text-slate-700 font-medium mb-2 block">1.4 Áreas com interface direta</Label>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">2. Sistemas & Tecnologia</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">3. Estrutura Bancária</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">4. Operacional e 5. Governança</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">6. Estratégico</h3>
        {renderTextarea(formData, handleFieldChange, b, 's6_visao_futuro', 'Visão de 12 meses')}
      </div>

      {/* Assinaturas Bloco 01 */}
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
        <h4 className="text-md font-bold text-slate-700 mb-4">Assinaturas e Validação (Bloco 01)</h4>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-primary/5 border border-primary/10 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          <Building className="w-6 h-6 text-primary" />
          <h2 className="text-2xl font-bold text-slate-800">Bloco 02 – Recebimento de Acessos</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {renderInput(formData, handleFieldChange, b, 'empresa_nome', 'Empresa (Razão Social/Fantasia)')}
          {renderInput(formData, handleFieldChange, b, 'responsavel_entrevista', 'Responsável pela entrevista')}
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">1. Bancos & Financeiro</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">2. ERP / Sistema</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">3. Faturamento & Fiscal</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">4. Contábil e 5. Operacional</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-b border-slate-100 pb-2">6. Infraestrutura</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
      ...
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
        <h4 className="text-md font-bold text-slate-700 mb-4">Assinaturas e Validação (Bloco 02)</h4>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="flex justify-between items-center pt-4">
        <Button variant="outline" onClick={onPrev} className="border-slate-300 text-slate-700">
