...
export default function DiagnosticoUploadSection({ clienteFasesId, uploads = {}, onUploadSuccess, onDeleteSuccess }) {
  ...
  return (
    <div className="mt-8 pt-6 border-t border-slate-200">
      <div className="mb-4">
        <h3 className="text-lg font-bold text-slate-800">Anexos do Diagnóstico</h3>
        <p className="text-sm text-slate-500">Faça o upload da Proposta de Melhoria gerada após a análise.</p>
      </div>
