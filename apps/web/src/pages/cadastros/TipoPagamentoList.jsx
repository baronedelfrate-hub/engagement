...
function TipoPagamentoList() {
  ...
  return (
    <div className="p-8 min-h-screen bg-slate-50">
      ...
      <PageHeader
        title={<span className="text-slate-900">Tipo de Pagamento</span>}
        description={<span className="text-slate-500">Gerencie os tipos de pagamento</span>}
        action={
      ...
      <div className="rounded-lg border border-slate-200 bg-white overflow-hidden">
        <DataTable
          ...
          emptyMessage={<span className="text-slate-500">Nenhum tipo de pagamento cadastrado</span>}
        />
      </div>
    </div>
  );
