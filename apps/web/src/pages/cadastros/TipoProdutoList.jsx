                  ...
                  <TableRow key={item.id} className="border-b border-border hover:bg-muted">
                    ...
                    <TableCell className="text-right text-foreground">
                      <div className="flex justify-end gap-2">
                        <Button variant="ghost" size="icon" className="text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:text-blue-400 dark:hover:text-blue-300 dark:hover:bg-blue-950/30" onClick={() => navigate(`/cadastros/tipo-produto/${item.id}`)}>
