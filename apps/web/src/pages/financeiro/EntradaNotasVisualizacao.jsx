...
const EntradaNotasVisualizacao = () => {
    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex justify-end gap-2">
          <Button variant="ghost" size="icon" onClick={() => navigate(`/financeiro/entrada-notas/${row.id}`)} title="Visualizar Detalhes">
  ...
  return (
    <>
      <Helmet>
        <title>Entradas de Notas - ERP Financeiro</title>
      </Helmet>

      <PageHeader
        title="Entradas de Notas"
        description="Gerencie todas as notas fiscais registradas no sistema."
        action={
