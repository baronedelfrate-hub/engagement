  ...
  return (
    <div className="bg-background border border-border rounded-lg p-4 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Status */}
        <div className="space-y-1">
          <Label className="text-xs text-muted-foreground">Status do Título</Label>
        ...
        {/* New: Filter by Prazo */}
        <div className="space-y-1">
          <Label className="text-xs text-muted-foreground">Filtro de Prazo</Label>
        ...
        {/* New: Filter by Phase */}
        <div className="space-y-1">
          <Label className="text-xs text-muted-foreground">Filtro de Fase</Label>
