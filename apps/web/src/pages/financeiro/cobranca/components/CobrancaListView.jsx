      ...
      <Table>
        <TableHeader className="bg-background">
          <TableRow className="border-border">
            ...
            <TableHead className="text-muted-foreground">Fase (Automática)</TableHead>
          ...
          {items.length === 0 ? (
            ...
            items.map((item) => (
              <TableRow key={item.id} className="border-border hover:bg-muted/50">
                <TableCell className="font-medium text-foreground">{item.cliente?.nome}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-muted-foreground">{item.responsavel?.nome || 'N/A'}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-right">
                  <Button variant="ghost" size="icon" onClick={() => onEdit(item)} className="h-8 w-8 text-muted-foreground hover:text-foreground">
