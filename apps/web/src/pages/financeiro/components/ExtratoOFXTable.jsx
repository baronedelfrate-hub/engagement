            ...
            {safeData.length === 0 ? (
              ...
              return (
                <TableRow 
                  ...
                  className={`border-slate-800/50 transition-colors cursor-pointer ${isSelected ? 'bg-indigo-900/20' : 'hover:bg-slate-800/30'}`}
                ...
                >
                  ...
                  <TableCell>
                    <div className="text-slate-200 text-sm truncate max-w-[180px]" title={row?.descricao || ''}>
                      {row?.descricao || 'S/N'}
                    </div>
