...
const getTableName = (clientId) => {
  return `clientes_bpo_${clientId.replace(/-/g, '_')}_tipos_produto`;
};
...
export const fetchById = async (clientId, id) => {
  try {
    ...
    console.error('Error fetching tipo de produto:', error);
    return { data: null, error };
  }
};
...
export const create = async (clientId, data) => {
  try {
    ...
    console.error('Error creating tipo de produto:', error);
    return { data: null, error };
  }
};
...
export const update = async (clientId, id, data) => {
  try {
    ...
    console.error('Error updating tipo de produto:', error);
    return { data: null, error };
  }
};
...
export const deleteRecord = async (clientId, id) => {
  try {
    ...
    console.error('Error deleting tipo de produto:', error);
    return { error };
  }
};