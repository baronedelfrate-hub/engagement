...
const getTableName = (clientId) => {
  return `clientes_bpo_${clientId.replace(/-/g, '_')}_unidades_medida`;
};
...
export const fetchById = async (clientId, id) => {
  try {
    ...
    console.error('Error fetching unidade de medida:', error);
    return { data: null, error };
  }
};
...
export const create = async (clientId, data) => {
  try {
    ...
    console.error('Error creating unidade de medida:', error);
    return { data: null, error };
  }
};
...
export const update = async (clientId, id, data) => {
  try {
    ...
    console.error('Error updating unidade de medida:', error);
    return { data: null, error };
  }
};
...
export const deleteRecord = async (clientId, id) => {
  try {
    ...
    console.error('Error deleting unidade de medida:', error);
    return { error };
  }
};